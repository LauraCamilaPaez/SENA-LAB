...
<div class="container">
    <div class="row">
        <div class="col-md-4 mt-5">
            <form action="?c=TipoContrato&m=update&id=<?php echo $tipo_contrato->id_tipo_contrato ?>" method="post">
                <div class="form-group">
                    <label for="tipo_contrato">Nombre del tipo de contrato</label>
                    <input type="text" class="form-control" id="tipo_contrato" name="tipo_contrato" value="<?php echo $tipo_contrato->tipo_contrato ?>">
                </div>
                <hr>
